...
class Teamset {
	...
	loadTeams() {
		var dPath = path.join(global.OUTPUT_PATH,"team");
		
		this.loadTeamsFromPath(dPath);
	}
	loadTeamsFromPath(teamDirPath) {
		console.log("Loading stored data…",teamDirPath);
		var files = fs.readdirSync(teamDirPath);
